    ...
    return (
        ...
        <div id='projects' class="container mt-5">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card">
                        <img src="https://source.unsplash.com/random/200×200/?coding" width="200" height="200"  class="card-img-top" alt="Project 1 Image" />
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card">
                        <img src="https://source.unsplash.com/random/200×200/?website" width="200" height="200" class="card-img-top" alt="Project 2 Image" />
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card">
                        <img src="https://source.unsplash.com/random/200×200/?videogame" width="200" height="200"  class="card-img-top" alt="Project 3 Image" />
                        <div class="card-body">
